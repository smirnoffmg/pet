...
Read the full solution hypothesis body — not just the title. The Experiments and Success criteria sections tell you what the feature must prove, which shapes scope and acceptance criteria.

## Required body sections

Each feature body must contain these four sections with substantive content:

- **Context** — why this feature exists: link it to the parent solution hypothesis and the business goal it serves. One or two paragraphs.
